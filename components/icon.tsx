export function LinkIcon({
    ...
    linkType: "external" | "external2" | "github" | "gitlab" | "docker" | "docker2" | "download",
    link: string
}) {
    switch (linkType) {
        case "external":
        case "external2": {
            return (
                <a href={link} target="_blank">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" className="transition ease-in-out duration-300 size-6 hover:text-sky-300">
        ...
        case "github": {
            return (
                <a href={link} target="_blank">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" className="transition ease-in-out duration-300 size-6 hover:text-gray-500">
        ...
        case "gitlab": {
            return (
                <a href={link} target="_blank">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" className="transition ease-in-out duration-300 size-6 hover:text-orange-500">
        ...
        case "docker2": {
            return (
                <a href={link} target="_blank">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" strokeWidth="2" stroke="currentColor" className="transition ease-in-out duration-300 size-6 hover:text-docker-100" viewBox="-237 239 24 24">
                    <g id="Layer_2">
                        <g>
        ...
        case "download": {
            return (
                <a href={link} target="_blank">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 -960 960 960" strokeWidth="2" stroke="currentColor" className="transition ease-in-out duration-300 size-6 hover:text-green-500" >
